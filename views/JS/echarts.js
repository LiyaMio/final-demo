...
function setRuntime(){
    ...
    if(n==3) {
        ...
        $.get('dataTime.json').done(function(data)
        {
            if((data.data.legend[0]=="SLCSS"&&(data.data.legend[1]=="SDTW"))||(data.data.legend[1]=="SLCSS"&&(data.data.legend[0]=="SDTW"))){
                myChart.setOption({
                        legend: {
                            y:385,
            ...
            }else if((data.data.legend[0]=="SLCSS"&&(data.data.legend[1]=="SBD"))||(data.data.legend[1]=="SLCSS"&&(data.data.legend[0]=="SBD"))){
                myChart.setOption({
                        legend: {
                            y:385,
            ...
            }else if((data.data.legend[0]=="SDTW"&&(data.data.legend[1]=="SBD"))||(data.data.legend[0]=="SDTW"&&(data.data.legend[1]=="SBD"))){
                myChart.setOption({
                        legend: {
                            y:385,
